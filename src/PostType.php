...
class PostType {
  ...
  */
  public function __construct($post_type_names, $options = []) {
    ...
    $this->add_action('manage_' . $this->post_type_name . '_posts_custom_column', [&$this, 'populate_admin_columns'], 10, 2);
  ...
  * @return mixed Returns the value on success, boolean false when it fails.
  */
  ...
  */
  private function set($var, $value) {
    // Array of reserved variables that cannot be overwritten.
    $reserved = [
      'config',
      'post_type_name',
      'singular',
    ...
    // Set if the variable is not a reserved variable
  ...
  public function add_taxonomy_filters() {
    ...
    if ($typenow == $this->post_type_name) {
      ...
      if (is_array($this->filters)) {
        ...
        // default to use all taxonomies associated with the post
  ...
  */
  private function populate_column($column_name, $callback) {
  ...
  *
  */
  private function make_columns_sortable($columns) {
